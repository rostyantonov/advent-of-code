...
import aoc.common.entity.asm.AsmComputer.Companion.C_REG
...
class Day12 : AoCFileInput<List<AsmInstruction>, Int>() {
     ...
     * it's assembunny code designed for the new computer you just assembled. You'll have to execute the code and
     * get the password.
     *
     ...
     * skip the last dec a (because a is not zero, so the jnz a 2 skips it), leaving register a at 42. When you
    ...
    override fun processPartOne(): Int =
        SimpleAsmComputer
            .execute(
                instructions = input,
                returnRegister = A_REG,
            ).toInt()
    // result 318 003 for part 1
