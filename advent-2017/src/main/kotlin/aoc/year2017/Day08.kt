...
import aoc.common.entity.StringConstants.STRING_EQUAL
import aoc.common.entity.StringConstants.STRING_GREATER
import aoc.common.entity.StringConstants.STRING_GREATER_OR_EQUAL
import aoc.common.entity.StringConstants.STRING_LESS
import aoc.common.entity.StringConstants.STRING_LESS_OR_EQUAL
import aoc.common.entity.StringConstants.STRING_NOT_EQUAL
            ...
            input.forEach { instruction ->
                ...
                val conditionResult =
                    when (instruction.condOperator) {
                        STRING_GREATER -> value > instruction.condAmount
                        STRING_LESS -> value < instruction.condAmount
                        STRING_GREATER_OR_EQUAL -> value >= instruction.condAmount
                        STRING_LESS_OR_EQUAL -> value <= instruction.condAmount
                        STRING_EQUAL -> value == instruction.condAmount
                        STRING_NOT_EQUAL -> value != instruction.condAmount
