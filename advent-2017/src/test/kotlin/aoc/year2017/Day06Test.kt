...
class Day06Test :
    AoCEmptyTest<Day06, Int>(),
    IAoCDoubleTest<Day06, Int> {
    @BeforeTest
    ...
    override fun partTwoInput(): Stream<Arguments> = Stream.of(Arguments.of(4, testRawInput))

    override fun realResults(): Stream<Arguments> = Stream.of(Arguments.of(5_042, 1_086))
}
