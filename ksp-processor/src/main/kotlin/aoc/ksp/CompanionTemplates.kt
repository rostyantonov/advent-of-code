...
internal class CompanionTemplates(
    ...
    fun enumEntity(
        ...
        return """
            ...
            | * Example:
            | *   val entity = ${className}Companion.fromLine("$sampleToken")   // -> $className.$sampleConstant
            | *
            | * Note: A line that matches no constant throws rather than parsing as null
            | */
            |object ${className}Companion : IStructureEnum<$className> {$skips
    ...
    fun lineBased(
        ...
        """
            ...
            |
            |import aoc.ksp.BaseEntity
            |import aoc.ksp.IStructureLine${extraImports(packageName, parameters)}
            |
            |/**
            | * Generated by KSP StructureProcessor
