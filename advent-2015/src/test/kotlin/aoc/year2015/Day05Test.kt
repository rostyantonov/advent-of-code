...
class Day05Test :
    AoCEmptyTest<Day05, Int>(),
    IAoCDoubleFunctionTest<Day05, Int, String, Boolean> {
    override val partOneFunc: (String) -> Boolean
        get() = currentDay::checkPartOneIsNice

    override val partTwoFunc: (String) -> Boolean
        get() = currentDay::checkPartTwoIsNice
