...
class Day14Test : AoCDoubleFunctionTest<Day14, Int, Int, Int>() {
    @BeforeTest
    override fun setupCurrentDay() {
        currentDay = Day14()
        partOneFunc = currentDay::functionPartOne
        partTwoFunc = currentDay::functionPartTwo
    }
    ...
    override fun partOneInput(): Stream<Arguments> = Stream.of(Arguments.of(1_120, testRawInput, 1_000))
    ...
    override fun partTwoInput(): Stream<Arguments> = Stream.of(Arguments.of(689, testRawInput, 1_000))

    override fun realResults(): Stream<Arguments> = Stream.of(Arguments.of(2_655, 1_059))
}
