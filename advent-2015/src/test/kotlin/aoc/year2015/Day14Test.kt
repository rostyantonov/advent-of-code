...
class Day14Test :
    ...
    IAoCDoubleFunctionTest<Day14, Int, Int, Int> {
    override val partOneFunc: (Int) -> Int
        get() = currentDay::functionPartOne

    override val partTwoFunc: (Int) -> Int
        get() = currentDay::functionPartTwo
    ...
    override fun partOneFunctionInput(): Stream<Arguments> = Stream.of(Arguments.of(1_120, testRawInput, 1_000))
    ...
    override fun partTwoFunctionInput(): Stream<Arguments> = Stream.of(Arguments.of(689, testRawInput, 1_000))
