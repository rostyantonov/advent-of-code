...
class Day25 : AoCFileInput<Position, Long>() {
     ...
     *
     * The weather machine beeps! On the console of the machine is a copy protection message asking you to enter
     * a code from the instruction manual. Apparently, it refuses to run unless you give it that code.
     ...
     * the codes are filled in diagonally up and to the right. This process repeats until the infinite paper is covered.
     ...
     * No Second Task
     */
    override fun processPartTwo(): Long = -1L
    // no task two
}
