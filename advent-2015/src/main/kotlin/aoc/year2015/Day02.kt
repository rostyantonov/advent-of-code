...
import aoc.year2015.entity.Present
import aoc.year2015.entity.PresentCompanion
...
class Day02 : AoCFileInput<List<Present>, Int>() {
    ...
    override fun processPartOne(): Int {
        return input.sumOf { present ->
            present.getAllSquares() + present.lowestSquare()
        }
        // result 1 606 483 for part 1
    }
    ...
    override fun processPartTwo(): Int {
        return input.sumOf { present ->
            present.lowestSidePerimeter() + present.multiplySides()
        }
        // result 3 842 356 for part 2
    }
}
