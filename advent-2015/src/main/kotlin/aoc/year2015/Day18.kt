...
import aoc.common.entity.CharConstants.CHAR_DOT as LIGHT_OFF
import aoc.common.entity.CharConstants.CHAR_HASHTAG as LIGHT_ON
import aoc.common.entity.CharConstants.CHAR_STAR as LIGHT_STAR
...
class Day18 : AoCFileInput<GridArray<Char>, Int>() {
    ...
    internal fun checkPartOne(steps: Int): Int {
        myInput = input.clone()
        return iterateSteps(steps)
    }

    internal fun checkPartTwo(steps: Int): Int {
        myInput = input.clone()
